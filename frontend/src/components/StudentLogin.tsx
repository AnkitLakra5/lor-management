...
import { ArrowBack, School as StudentIcon } from '@mui/icons-material';
...
const StudentLogin: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check if the logged-in user is actually a student
      ...
      if (userRole !== 'STUDENT') {
        ...
        logout();
        setError(`Access denied. This is the Student Portal. You are logged in as ${userRole}. Please use the correct portal for your role.`);
        return;
      }
        ...
        >
          <Paper elevation={6} sx={{ padding: 4, width: '100%', borderRadius: 3 }}>
            ...
            <Typography variant="body1" align="center" color="text.secondary" sx={{ mb: 3 }}>
              Access your LOR requests, track status, and download approved letters.
            </Typography>
            ...
            <Box component="form" onSubmit={handleSubmit} sx={{ mt: 1 }}>
              ...
              <Button
                ...
                disabled={isLoading}
              >
                {isLoading ? <CircularProgress size={24} color="inherit" /> : 'Sign In as Student'}
              </Button>
