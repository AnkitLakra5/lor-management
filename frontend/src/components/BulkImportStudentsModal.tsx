...
const BulkImportStudentsModal: React.FC<BulkImportStudentsModalProps> = ({
  open,
  onClose,
  onImportComplete
}) => {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      setImportResult({
        ...
        successCount: 0,
        errorCount: 1,
        errors: [error.response?.data?.message || 'Failed to import students'],
        importedStudents: [],
          ...
          <>
            ...
            <Alert severity="info" sx={{ mb: 3 }}>
              <Typography variant="body2">
                ...
                <br />
                2. Fill in your student data (remove example rows and instruction lines)
                <br />
